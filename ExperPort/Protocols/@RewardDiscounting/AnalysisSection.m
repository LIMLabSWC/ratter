...
%% init  
  case 'init',
    ...
    DispParam(obj, 'Hit_Frac',       0, x, y); next_row(y);
    DispParam(obj, 'Choose_Left',    0, x, y); next_row(y);
    DispParam(obj, 'Choose_Right',   0, x, y); next_row(y,1.5);
    
    DispParam(obj, 'Free_Trials',    0, x, y); next_row(y);
    DispParam(obj, 'Forced_Trials',  0, x, y); next_row(y);
    DispParam(obj, 'Trial_Count',    0, x, y); next_row(y,1.5);
    
    DispParam(obj, 'MultiDay_Free',  0, x, y); next_row(y);
    DispParam(obj, 'MultiDay_Forced',0, x, y); next_row(y);
    DispParam(obj, 'MultiDay_Total', 0, x, y); next_row(y,1.5);
    
    DispParam(obj, 'Duration_Ratio', 0, x, y); next_row(y);
    DispParam(obj, 'Reward_Ratio',   0, x, y); next_row(y);
    
    SubheaderParam(obj, 'title', 'Analysis Section', x, y);
    next_row(y, 0.5);
    
    SoloParamHandle(obj, 'Indifference1', 'value', []);
    SoloParamHandle(obj, 'Indifference2', 'value', []);
    SoloParamHandle(obj, 'Indifference3', 'value', []);
    SoloParamHandle(obj, 'Indifference4', 'value', []);
    
    SoloParamHandle(obj, 'DoneWithStage', 'value', 0);
