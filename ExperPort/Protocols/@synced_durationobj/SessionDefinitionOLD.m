...
switch action
    ...
    case 'eod_save'
       ...
       uicontrol('Style','text', 'Position',[80 10 300 50],'BackgroundColor',[1 1 0], 'Fontsize', 14, 'FontWeight','bold', 'String', sprintf('Currently saving settings/data.\nPlease wait.'));
        ...
        my_session_model.value = sm;
        save_soloparamvalues(ratname, 'child_protocol', my_owner, 'commit', 1,'interactive',0,'experimenter',experimenter);         
        save_solouiparamvalues(ratname, 'child_protocol', my_owner, 'commit', 1,'interactive', 0,'tomorrow',1,'experimenter',experimenter);    
