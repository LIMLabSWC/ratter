...
%  Cin Cout Lin Lout Rin Rout TimeUp Timer DIO AO  
    ...
    3    3   3    3   3    3   35     wvd   1   1;  % State 3 "Valid Poke ==> Water!!! :)"
    4    4   4    4   4    4   35     wvd   2   1;];% State 4 "Valid Poke ==> Water!!! :)"
...
%  Cin Cout Lin Lout Rin Rout TimeUp Timer DIO AO  
    ...
    6    6   6    6   6    6   35     wvd   1   1;  % State 6 "Valid Poke ==> Water!!! :)"
    7    7   7    7   7    7   35     wvd   2   1;];% State 7 "Valid Poke ==> Water!!! :)"
...
%  Cin Cout Lin Lout Rin Rout TimeUp Timer DIO AO  
    ...
    9    9   9    9   9    9   35     wvd   1   1;  % State 9    
   10   10  10   10  10   10   35     wvd   2   1;];% State 10
...
%  Cin Cout Lin Lout Rin Rout TimeUp Timer DIO AO  
   ...
   12   12  12   12  12   12   35     wvd   1   1;  % State 12   
   13   13  13   13  13   13   35     wvd   2   1;];% State 13
...
%  Cin Cout Lin Lout Rin Rout TimeUp Timer DIO AO  
   ...
   15   15   15   15  15   15  35     wvd   1   1;  % State 15   
   16   16   16   16  16   16  35     wvd   2   1;];% State 16
...
%  Cin Cout Lin Lout Rin Rout TimeUp Timer DIO AO  
   ...
   18   18   18   18  18   18  35     wvd   1   1;  % State 18   
   19   19   19   19  19   19  35     wvd   2   1;];% State 19
