...
function [] = initialize_centerpokes_plot
    ...
    k = line([0], [0]);  set(k, 'Color', 'k', 'Marker', '.', 'LineStyle', '-', 'Tag', 'kline');
    r = line([0], [0]);  set(r, 'Color', 'r', 'Marker', '.', 'LineStyle', 'none', 'Tag', 'rline');
    r = line([0], [0]);  set(r, 'Color', 'g', 'Marker', '.', 'LineStyle', 'none', 'Tag', 'gline');
    r = line([0], [0]);  set(r, 'Color', 'b', 'Marker', '.', 'LineStyle', 'none', 'Tag', 'bline');
