function [out] = SeqDiscSamp9(varargin)
...
SetRetriggerState( 'Withdrawal', 'Tup',  'ITIState', 'Time', wntime, 'Aout', wnsound, 'Loop', withdrawalloop ); % premature withdrawal- time out
