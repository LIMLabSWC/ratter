function out = Tone2AFC_25_200ms_15k2k(varargin)
...
switch action
    ...
    case 'init'
        ...
        Ratio={[ 8     8     8    9     9     8     8     9    9    8     8    8],
               ...
               [15    12     0   11    10     0     0    10   11    0    12   15],
               [22    12     0   14     2     0     0     2   14    0    12   22],
               [28     0     0   22     0     0     0     0   22    0     0   28],
               [48     0     0    2     0     0     0     0    2    0     0   48],
               [ 0    25     0    0    25     0     0    25    0    0    25    0]};
        Ratio_Str ={'Full task' 'Advance(L6)' 'Intermediate(L5)' 'Basic(L4)' 'Easy(L3)' 'level=2' 'level=1','Mid-Level'}; 
...
%         TmOut=fliplr(TmOut);
        ...
        InitParam(me,'lWaterValveDur','ui','edit','value',.15,'pos',[h+hs*4.3 n*vs hs*.7 vs]);
...
if pts+dd==1
    ...
    %  Cin Cout Lin Lout Rin Rout TimeUp        Timer DIO  AO  
        ...
        5    5   5    5   5    5   35           rvd   2    0;   % State 5 "Valid Poke ==> Water!!! :)"
...
elseif pts+dd==2
    state_transition_matrix=[ ...                            % Left Side Water Port
     %  Cin Cout Lin Lout Rin Rout TimeUp        Timer DIO  AO  
        ...
        15   15  15   15  15   15   35           lvd   1    0;   % State 15 "Valid Poke ==> Water!!! :)"
...
elseif pts+dd==3	
    state_transition_matrix=[ ...                            % Both Side Water Port
     %  Cin Cout Lin Lout Rin Rout TimeUp        Timer DIO  AO  
        ...
        25   25  25   25  25   25   35    (rvd+lvd)/2  3    0;   % State 25 "Valid Poke ==> Water!!! :)"
...
elseif pts+dd==4
    ...
    %  Cin Cout Lin Lout Rin Rout TimeUp        Timer DIO  AO  
        ...
        2    6   2    2    2   2    3           tnd   0    1;   % State 2 "tone on"
        3    6   3    3    3   3    4           rdd   0    1;   % State 3 "pre- Center Poke out"
        4    4   4    4    4   4    5           rvd   2    3;   % State 4 "Valid Poke ==> Water!!! :)"
...
elseif pts+dd==5
    state_transition_matrix=[ ...                            % Left Side Water Port
     %  Cin Cout Lin Lout Rin Rout TimeUp        Timer DIO  AO  
        ...
        12   16  12   12  12   12   13           tnd   0    1;   % State 12 "tone on"
        13   16  13   13  13   13   14           rdd   0    1;   % State 13 "pre- Center Poke out"
        14   14  14   14  14   14   15           lvd   1    3;   % State 14 "Valid Poke ==> Water!!! :)"
...
elseif pts+dd==6	
    state_transition_matrix=[ ...                            % Both Side Water Port
     %  Cin Cout Lin Lout Rin Rout TimeUp        Timer DIO  AO  
        ...
        22   26  22   22  22   22   23           tnd   0    1;   % State 22 "tone on"
        23   26  23   23  23   23   24           rdd   0    1;   % State 23 "pre- Center Poke out"
        24   24  24   24  24   24   25    (rvd+lvd)/2  3    3;   % State 24 "Valid Poke ==> Water!!! :)"
