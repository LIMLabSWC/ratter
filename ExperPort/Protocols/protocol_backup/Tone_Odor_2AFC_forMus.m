...
if pts+dd==1
    ...
    %  Cin Cout Lin Lout Rin Rout TimeUp        Timer DIO  AO  
        ...
        4    5   8    4   6    4    5           ltd   odr  1;   % State 4 "pre- Center Poke out"
        5    5   8    5   6    5    9           wad   vpo  2;   % State 5 "Reward Avaiable Dur"
        6    6   6    6   6    6   35           rvd   2   vpt;  % State 6 "Valid Poke ==> Water!!! :)"
...
elseif pts+dd==2
    ...
    %  Cin Cout Lin Lout Rin Rout TimeUp        Timer DIO  AO  
       ...
       14   15  16   14  18   14   15           ltd   odr  1;   % State 14 "pre- Center Poke out"
       15   15  16   15  18   15   19           wad   vpo  2;   % State 15 "Reward Avaiable Dur"
       16   16  16   16  16   16   35           lvd   1   vpt;  % State 16 "Valid Poke ==> Water!!! :)"
...
elseif pts+dd==3	
    state_transition_matrix=[ ...                               % Both Side Water Port
     %  Cin Cout Lin Lout Rin Rout TimeUp        Timer DIO AO  
       ...
       22   28  22   22  22   22   23           dly   dlo dlt;   % State 22 "Center Poke in, before tone on"
       23   28  23   23  23   23   24+(ltd==0)  vpd   odr  1;   % State 23 "tone on"
       24   25  26   24  27   24   25           ltd   odr  1;   % State 24 "pre- Center Poke out"
       25   25  26   25  27   25   30           wad   vpo  2;   % State 25 "Reward Avaiable Dur"
       26   26  26   26  26   26   35           lvd   1   vpt;  % State 26 "Valid Poke ==> Water!!! :)"
       27   27  27   27  27   27   35           rvd   2   vpt;  % State 27 "Valid Poke ==> Water!!! :)"
       28   28  28   28  28   28   35           tmo   0    0;   % State 28 "ShortPoke => Abort => House Light "
       29   29  29   29  29   29   35           tmo   0    0;   % State 29 "FalsePoke, wrong side => House Light "
       30   30  30   30  30   30   35           tmo   0    0;]; % State 30 "ValidTonePoke but missed reward => House Light "
elseif pts+dd==4
