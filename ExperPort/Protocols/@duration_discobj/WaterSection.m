...
function [x, y] = WaterSection(obj, action, x, y)
   ...
   switch action
    case 'init',
      ...
      EditParam(obj, 'Right_volume', 24, x, y, 'position', [x y 80 20], ...
                'labelfraction', 0.7, 'label', 'Right uL');  
      DispParam(obj, 'RightWValve', 0.02, x, y, 'position', ...
                [x+90 y 110 20], 'labelfraction', 0.65, ...
                'label', 'Rt Wtr time'); 
      next_row(y);

      EditParam(obj, 'Left_volume', 24, x, y, 'position', [x y 80 20], ...
                'labelfraction', 0.7, 'label', 'Left uL');  
      DispParam(obj, 'LeftWValve', 0.02, x, y, 'position', ...
                [x+90 y 110 20], 'labelfraction', 0.65, ...
                'label', 'Lt Wtr time');
    ...
    case 'calculate', 
%         LeftWValve.value = 0.02;
%         RightWValve.value = 0.02;
      [wt, errid, message] = ...
      ...
      if isnan(wt),
         ...
         RightWValve.value = 0.01; % Never dispense 0: it confuses the RTFSM
      else
      ...
      if isnan(wt),
         ...
         LeftWValve.value = 0.01; % Never dispense 0: it confuses the RTFSM
      else
