% [out] = Dualpoke(varargin)
%
% This file Dualpoke.m, together with the directory @Dualpokeobj, is an
...
% used immediately.) The top-level file Dualpoke.m provides part of the
% interface between Exper and Solo/RTLinux.
%
% Copy and tweak this Dualpoke to write your own protocol. This top-level
...
%
% We will assume that your @Dualpokeobj directory contains the following
% methods (plus some others relevant to your protocol, of course):
%
%    Dualpokeobj.m, a constructor method, called once when the protocol
%                is opened.
...
%          (the expt is over).
%
% Given those methods, this top-level file, Dualpoke.m, will work for
% every protocol. There is no need to modify it at all (other than to
% replace 'Dualpoke', of course, by some name of your choice.)
%

% CDB 9-Feb-06

function [out] = Dualpoke(varargin)
