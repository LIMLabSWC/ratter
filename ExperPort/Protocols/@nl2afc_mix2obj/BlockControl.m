...
switch action,
    case 'init',
        ...
        next_row(y);
        MenuParam(obj, 'mixid_rept',{1, 2},1 , x,y, 'position',[x y 100 20]);
        NumeditParam(obj,'repts', 60, x, y, 'position', [x+50 y 150 20],...
            'labelpos', 'left', 'TooltipString', 'Number of repeats for each mixture in the random condition');
        SoloParamHandle(obj, 'mix_repts', 'value', ones(1,2)*value(repts)); 
