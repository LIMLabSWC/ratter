...
InterStimDelay = 1 + (value(InterStimDelayHi)-value(InterStimDelayLo)).*rand;
...
ModeDirect = 'Deliver_Stim4';
elseif (strcmp(value(Task_Phase),'Lick4Second'))
ModeDirect = 'Deliver_Stim3';
else 
...
sma = StateMachineAssembler('full_trial_structure');
        ...
        sma = add_state(sma, 'name', 'Deliver_Stim3', ...
                        'self_timer', CueDuration2,...
                        'input_to_statechange', ...
                        {'Tup', 'Inter_Stim_Delay3', 'Cin', 'impatient_iti'},...
                        'output_actions', {'SoundOut', Third_Snd,'DOut', 0}); ...
        sma = add_state(sma, 'name', 'Inter_Stim_Delay3', ...
                        'self_timer', InterStimDelay,...
                        'input_to_statechange', ...
                        {'Tup', 'Deliver_Stim4', 'Cin', 'impatient_iti'},...
                        'output_actions',{}); ...
        sma = add_state(sma, 'name', 'Deliver_Stim4', ...
                        'self_timer', CueDuration2,...
                        'input_to_statechange', ...
                        {'Tup', 'Delay2Response', 'Cin', 'impatient_iti'},...
                        'output_actions', {'SoundOut', Fourth_Snd,'DOut', 0}); ...
        sma = add_state(sma, 'name', 'Delay2Response', ...
                        'self_timer', Response_Delay,...
                        'input_to_statechange', {'Tup', 'Wait4Response','Cin', 'impatient_iti'},...
                        'output_actions',{}); ...
        sma = add_state(sma, 'name', 'Wait4Response', ...
                        'self_timer', Response_Window,...
                        'input_to_statechange', ...
                        {'Tup', MatchAct2 , 'Cin', MatchAct1 },...
