...
switch action,
  ...
  case 'init'
    ...
    NumeditParam(obj, 'SoundDuration', 0.25, xpos, ypos, 'TooltipString',...
    'Forced Delay Longest'); next_row(ypos,1.0);
    ...
    SoloParamHandle(obj, 'Fourth_Sound', 'value', 'Sound_A');
...
SoundModulatory = 5 *...
sin(2*pi*30*s);
s = .1*sin(2*pi*2995*s + SoundModulatory);
  ...
  case 'prepare_next_trial'
   ...
   if(n_done_trials>1)
         ...
         case 1
             ...
             Third_Sound.value = 'Sound_C';
             Fourth_Sound.value = 'Sound_A';
         ...
         case 2
             ...
             Third_Sound.value = 'Sound_A';
             Fourth_Sound.value = 'Sound_B';
             Match_Action1.value = 'reward';
             Match_Action2.value = 'iti'; 
         ...
         case 3
             ...
             Third_Sound.value = 'Sound_B';
             Fourth_Sound.value = 'Sound_C';
             Match_Action1.value = 'reward';
             Match_Action2.value = 'iti'; 
         ...
         case 6
          ...
          SoloFunctionAddVars('StateMatrixSection', 'rw_args',...
                        {'First_Sound','Second_Sound', 'Third_Sound', 'Fourth_Sound'...
