...
%% add_sma_states
  ...
  case 'add_sma_states'
    ...
    pairs = { ...
      ...
      'DOutStartTime'             1e6 ; ...
      'DOutOnTime'                1e6 ; ...
      'DOut2'                     1/2; ... % <~> -1 changed to 1/2. We need to take the log2 of DOut to get the channel number. As the log2 command is added below, this value is adjusted to result in -1 after the log2. Bugfix 2007.Dec.17 19:07.
      'DOut2StartTime'            1e6 ; ...
      'DOut2OnTime'               1e6 ; ...
      'ConstantDOut'              0; ...
      'Sound1TrigTime'            1e6 ; ...
   ...
   % -- 2)  StartNoseOutDoff                                               --- StartNoseOutDoff        (2)
    sma = add_state(sma, 'self_timer', 0.0001, ...  StartNoseOutDoff (2)
      'output_actions', {'SchedWaveTrig', Grace,...
                         'DOut', Doff}, ...
      'input_to_statechange', { ...
   ...
   % -- 5)  StartNoseOutDon                                                --- StartNoseOutDon         (5)
    sma = add_state(sma, 'self_timer', 0.0001, ... %StartNoseOutDon
      'output_actions', {'SchedWaveTrig', Grace,...
                         'DOut', Don}, ...
      'input_to_statechange', { ...
   ...
   % -- 7)  NoseInSound1TrigDoff                                           --- NoseInSound1TrigDoff    (7)
    sma = add_state(sma, 'self_timer', 0.0001, ... %NoseInSound1TrigDoff (7)
   ...
   % -- 8)  NoseInSound2TrigDoff                                           --- NoseInSound2TrigDoff    (8)
    sma = add_state(sma, 'self_timer', 0.0001, ... %NoseInSound2TrigDoff (8)
   ...
   % -- 9)  NoseInSound1TrigDon                                            --- NoseInSound1TrigDon     (9)
    sma = add_state(sma, 'self_timer', 0.0001, ... %NoseInSound1TrigDon (9)
      'output_actions', {'SoundOut', Sound1Id, ...
                         'DOut', Don}, ...
      'input_to_statechange', { ...
   ...
   % -- 10) NoseInSound2TrigDon                                            --- NoseInSound2TrigDon     (10)
    sma = add_state(sma, 'self_timer', 0.0001, ... %NoseInSound2TrigDon (10)
      'output_actions', {'SoundOut', Sound2Id,...
                         'DOut', Don}, ...
      'input_to_statechange', { ...
   ...
   % -- 11) NoseOutSound1TrigDoff                                          --- NoseOutSound1TrigDoff   (11)
    sma = add_state(sma, 'self_timer', 0.0001, ... %NoseOutSound1TrigDoff (11)
      'output_actions', {'SoundOut', Sound1Id, ...
                         'DOut',     Doff}   , ...
      'input_to_statechange', { ...
   ...
   % -- 12) NoseOutSound2TrigDoff                                          --- NoseOutSound2TrigDoff   (12)
    sma = add_state(sma, 'self_timer', 0.0001, ... %NoseOutSound2TrigDoff (12)
      'output_actions', {'SoundOut', Sound2Id, ...
                         'DOut',     Doff}   , ... 
      'input_to_statechange', { ...
   ...
   % -- 13) NoseOutSound1TrigDon                                           --- NoseOutSound1TrigDon    (13)
    sma = add_state(sma, 'self_timer', 0.0001, ... %NoseOutSound1TrigDon (13)
      'output_actions', {'SoundOut', Sound1Id, ...
                         'DOut',     Don}    , ...
      'input_to_statechange', { ...
   ...
   % -- 14) NoseOutSound2TrigDon                                           --- NoseOutSound2TrigDon    (14)
    sma = add_state(sma, 'self_timer', 0.0001, ... %NoseOutDonSound2Trig (14)
      'output_actions', {'SoundOut', Sound2Id, ...
                         'DOut',     Don}    , ...
      'input_to_statechange', { ...
   ...
   % -- 15) Success cleanup and exit                                       --- Success_Cleanup         (15)
    sma = add_state(sma, 'self_timer', 0.0001, ...  %success_cleanup (15)
   ...
   % -- 16) Abort cleanup and exit                                         --- Abort_Cleanup           (16)
    sma = add_state(sma, 'self_timer', 0.0001, ...  %abort_cleanup (16)
      'output_actions', {'SoundOut', -abs(Sound1Id), ...
      'SchedWaveTrig', ['-(' Duration ' + ' Grace ' + ' Sound1...
                       ' + ' DOutWave ' + ' DOut2Wave ')']}, ...
   ...
   % -- 18) StartNoseOutD2on                                               --- StartNoseOutD2on        (18)
    sma = add_state(sma, 'self_timer', 0.0001, ...  StartNoseOutD2on (2)
      'output_actions', {'SchedWaveTrig', Grace,...
                         'DOut'         , D2on}, ...
      'input_to_statechange', { ...
   ...
   % -- 21) StartNoseOutDonD2on                                            --- StartNoseOutDonD2on     (21)
    sma = add_state(sma, 'self_timer', 0.0001, ... %StartNoseOutDonD2on                      
      'output_actions', {'SchedWaveTrig', Grace,...
                         'DOut', DonD2on}, ...
      'input_to_statechange', { ...
   ...
   % -- 23) NoseInSound1TrigD2on                                           --- NoseInSound1TrigD2on    (23)
    sma = add_state(sma, 'self_timer', 0.0001, ... %NoseInSound1TrigD2on (7)
      'output_actions', {'SoundOut', Sound1Id, ...
                         'DOut'    , D2on}   , ...
      'input_to_statechange', { ...
   ...
   % -- 24) NoseInSound2TrigD2on                                           --- NoseInSound2TrigD2on    (24)
    sma = add_state(sma, 'self_timer', 0.0001, ... %NoseInSound2TrigD2on (24)
      'output_actions', {'SoundOut', Sound2Id, ...
                         'DOut'    , D2on}   , ...
      'input_to_statechange', { ...
   ...
   % -- 25) NoseInSound1TrigDonD2on                                        --- NoseInSound1TrigDonD2on (25)
    sma = add_state(sma, 'self_timer', 0.0001, ... %NoseInDonD2onSound1Trig (25)        
      'output_actions', {'SoundOut', Sound1Id, ...
                         'DOut'    , DonD2on}, ...
      'input_to_statechange', { ...
   ...
   % -- 26) NoseInSound2TrigDonD2on                                        --- NoseInSound2TrigDonD2on (26)
    sma = add_state(sma, 'self_timer', 0.0001, ... %NoseInSound2TrigDonD2on (26)       
      'output_actions', {'SoundOut', Sound2Id, ...
                         'DOut'    , DonD2on}, ...
      'input_to_statechange', { ...
   ...
   % -- 27) NoseOutSound1TrigD2on                                          --- NoseOutSound1TrigD2on   (27)
    sma = add_state(sma, 'self_timer', 0.0001, ... %NoseOutSound1TrigD2on (27)
      'output_actions', {'SoundOut', Sound1Id, ...
                         'DOut'    , D2on}   , ...
      'input_to_statechange', { ...
   ...
   % -- 28) NoseOutSound2TrigD2on                                          --- NoseOutSound2TrigD2on   (28)
    sma = add_state(sma, 'self_timer', 0.0001, ... %NoseOutSound2TrigD2on (28)
      'output_actions', {'SoundOut', Sound2Id, ...
                         'DOut'    , D2on}   , ... 
      'input_to_statechange', { ...
   ...
   % -- 29) NoseOutSound1TrigDonD2on                                       --- NoseOutSound1TrigDonD2on (29)
    sma = add_state(sma, 'self_timer', 0.0001, ... %NoseOutSound1TrigDonD2on (29)
      'output_actions', {'SoundOut', Sound1Id,...
                         'DOut',     DonD2on},...
      'input_to_statechange', { ...
   ...
   % -- 30) NoseOutSound2TrigDonD2on                                       --- NoseOutSound2TrigDonD2on (30)
    sma = add_state(sma, 'self_timer', 0.0001, ... %NoseOutSound2TrigDonD2on (30)
      'output_actions', {'SoundOut', Sound2Id,...
                         'DOut',     DonD2on},...
      'input_to_statechange', { ...
