...
function [obj] =Withholding(varargin)
...
switch action,
    ...
    case 'init'
        ...
        my_state_colors = struct( ...
            ...
            'waiting2_lp',              [1 1 1],   ...
            'waiting3_lp',              [1 1 1],   ...
            'cue_state_np',                  [1 0.5 0.5],   ...
            'waiting_small1_np',      	 [0.8 1 0.8],   ...
            'waiting_small2_np',      	 [0.8 1 0.8],   ...
            'waiting_small3_np',      	 [0.8 1 0.8],   ...
            'waiting_small4_np',      	 [0.8 1 0.8],   ...
            'waiting_small1_lp',      	 [0.8 1 0.8],   ...
            'waiting_small2_lp',      	 [0.8 1 0.8],   ...
            'waiting_small3_lp',      	 [0.8 1 0.8],   ...
            'waiting_small4_lp',      	 [0.8 1 0.8],   ...
            'waiting_large1_np',        [0.5 1 0.5],   ...
            'waiting_large2_np',        [0.5 1 0.5],   ...
            'waiting_large3_np',        [0.5 1 0.5],   ...
            'waiting_large4_np',        [0.5 1 0.5],   ...
            'waiting_large1_lp',        [0.5 1 0.5],   ...
            'waiting_large2_lp',        [0.5 1 0.5],   ...
            'waiting_large3_lp',        [0.5 1 0.5],   ...
            'waiting_large4_lp',        [0.5 1 0.5],   ...
            'short_poke1',           [1 1 0.7],   ...
            'short_poke2',           [1 1 0.7],   ...
            'short_poke3',           [1 1 0.7],   ...
            'small_available1',   	 [0.8 0.8 1],   ...
            'small_available2',   	 [0.8 0.8 1],   ...
            'small_available3',   	 [0.8 0.8 1],   ...
            'large_available1',  	 [0.9 0.8 1],   ...
            'large_available2',  	 [0.9 0.8 1],   ...
            'large_available3',  	 [0.9 0.8 1],   ...
            'zero_available1',  	 [1 0.7 0.7],   ...
            'zero_available2',  	 [1 0.7 0.7],   ...
            'zero_available3',  	 [1 0.7 0.7],   ...
        ...
        SoloFunctionAddVars('AutomationSection', ...
            'rw_args', {Adaptive_N, Adaptive_L, ...
                        ...
                        VpdSmall_N, VpdLargeMin_N, VpdLargeMean_N, VpdRest_N,VpdCue_N,...
