...
switch action
  ...
  case 'prepare_next_trial',
    ...
    if isequal(stim.loc, 'anti-loc'), 
      if side == 'l', HitEvent = 'Rin'; HitState = 'RightHit'; WaterTime = RtValve; WaterValve = right1water; 
      else            HitEvent = 'Lin'; HitState = 'LeftHit';  WaterTime = LtValve; WaterValve = left1water;
      end; 
    else
      if side == 'l', HitEvent = 'Lin'; HitState = 'LeftHit';  WaterTime = LtValve; WaterValve = left1water;
      else            HitEvent = 'Rin'; HitState = 'RightHit'; WaterTime = RtValve; WaterValve = right1water; 
      end; 
    end;
