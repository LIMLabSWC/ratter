% Constructor
function [obj] = newclassicalobj(a)
...
set(value(myfig), 'Position', [485    97   698   541]);
...
SoloFunctionAddVars('PokesPlotSection', 'ro_args', {'RealTimeStates', 'LastTrialEvents'});
[x, y] = PokesPlotSection(obj, 'init', x, y);


% ... and the pretty bow
fig_position = get(value(myfig), 'Position');
HeaderParam(obj, 'prot_title', 'NewClassical', 1, fig_position(4)-20, ...
...
SoloParamHandle(obj, 'within_trial_update_actions', 'value', { ...
  'RewardsSection(obj, ''update_events'');'         ; ...
