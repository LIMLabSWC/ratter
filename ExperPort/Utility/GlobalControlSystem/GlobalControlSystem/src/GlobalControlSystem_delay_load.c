 ...
 */
FARPROC WINAPI GlobalControlSystemDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = GlobalControlSystemDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = GlobalControlSystemDelayLoadWin32FailureHook;
#endif
