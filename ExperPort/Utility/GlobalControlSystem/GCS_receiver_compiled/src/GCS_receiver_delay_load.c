 ...
 */
FARPROC WINAPI GCS_receiverDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = GCS_receiverDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = GCS_receiverDelayLoadWin32FailureHook;
#endif
