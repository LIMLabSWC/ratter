...
% Modified 1/13 by kjm to handle the case of six-poke rigs

function [obj, varargout] = rigtester2(varargin)
...
switch action
    ...
    case 'init'
        ...
        % Decide if we're a three-poke rig or a six-poke rig
        nInputs = length(bSettings('get','INPUTLINES','all'));
        if nInputs == 6
            sixpokerig = true;
        else
            sixpokerig = false;
        ...
        SoloParamHandle(obj, 'left2led', 'value', bSettings('get', 'DIOLINES', 'left2led'));
        SoloParamHandle(obj, 'center2led', 'value', bSettings('get', 'DIOLINES', 'center2led'));
        SoloParamHandle(obj, 'right2led', 'value', bSettings('get', 'DIOLINES', 'right2led'));
        ...
        set(value(rig_tester_gui), 'Position', [37.4000   28.8462  105.2000+105*sixpokerig   38.4615]);
        ...
        uipanel('Parent', value(rig_tester_gui), ...
            'Units', 'characters', ...
            'Tag', 'uipanelLeftPoke2', ...
            'FontSize', 10.0, ...
            'FontWeight', 'bold', ...
            'Position', [109.6 17.846 30.2 11.615], ...
            'Title', 'LEFT POKE 2', ...
            'BackgroundColor', 'green', ...
            'TitlePosition', 'centertop');
        ...
        uipanel('Parent', value(rig_tester_gui), ...
            'Units', 'characters', ...
            'Tag', 'uipanelCenterPoke2', ...
            'FontSize', 10.0, ...
            'FontWeight', 'bold', ...
            'Position', [139.6 17.846 30.2 11.615], ...
            'Title', 'CENTER POKE 2', ...
            'BackgroundColor', 'green', ...
            'TitlePosition', 'centertop');
        ...
        uipanel('Parent', value(rig_tester_gui), ...
            'Units', 'characters', ...
            'Tag', 'uipanelRightPoke2', ...
            'FontSize', 10.0, ...
            'FontWeight', 'bold', ...
            'Position', [169.6 17.846 30.2 11.615], ...
            'Title', 'RIGHT POKE 2', ...
            'BackgroundColor', 'green', ...
            'TitlePosition', 'centertop');
        end
        ...
        uipanel('Parent', value(rig_tester_gui), ...
            ...
            'FontSize', 8.0, ...
            'FontWeight', 'normal', ...
            'Position', [4.6 7.077 100.4+100*sixpokerig 8.308], ...
            'Title', 'Bypass', ...
        ...
        if sixpokerig
        %left2led
        ToggleParam(obj, 'btnLeft2LED', false, 1, 1, 'OnString', 'Left LED 2', 'OffString', 'Left LED 2');
        set(get_ghandle(btnLeft2LED), ...
            'Parent', handles.uipanelBypass, ...
            'Units', 'characters', ...
            'Tag', 'btnLeft2LED', ...
            'String', 'Left LED 2', ...
            'HorizontalAlignment', 'center', ...
            'Position', [105 4.692 20.2 2]);
        set_callback(btnLeft2LED, {mfilename, 'btnLeftLED2Callback'});
        %center2led
        ToggleParam(obj, 'btnCenter2LED', false, 1, 1, 'OnString', 'Center LED 2', 'OffString', 'Center LED 2');
        set(get_ghandle(btnCenter2LED), ...
            'Parent', handles.uipanelBypass, ...
            'Units', 'characters', ...
            'Tag', 'btnCenter2LED', ...
            'String', 'Center LED 2', ...
            'HorizontalAlignment', 'center', ...
            'Position', [140 4.692 20.2 2]);
        set_callback(btnCenter2LED, {mfilename, 'btnCenterLED2Callback'});
        %right2led
        ToggleParam(obj, 'btnRight2LED', false, 1, 1, 'OnString', 'Right LED 2', 'OffString', 'Right LED 2');
        set(get_ghandle(btnRight2LED), ...
            'Parent', handles.uipanelBypass, ...
            'Units', 'characters', ...
            'Tag', 'btnRight2LED', ...
            'String', 'Right LED 2', ...
            'HorizontalAlignment', 'center', ...
            'Position', [175 4.692 20.2 2]);
        set_callback(btnRight2LED, {mfilename, 'btnRight2LEDCallback'});
        end
        ...
        inputlines_offset = bSettings('get', 'INPUTLINES_MISC', 'offset');
        if isnan(inputlines_offset)
            inputlines_offset = 0;
        end
        diolines_offset = bSettings('get', 'DIOLINES_MISC', 'offset');
        ...
        if sixpokerig
            ...
            inlines = struct('C',1+inputlines_offset,'L',2+inputlines_offset,'R',3+inputlines_offset);
            line_names = 'CLR';
        end
        ...
        sma.value = StateMachineAssembler('full_trial_structure','use_happenings',1,'n_input_lines',length(line_names),'line_names',line_names);
        ...
        dout_lines = bSettings('get', 'DIOLINES', 'all');
    ...
    case 'recalculate_bypass'
        ...
        if ~isnan(value(left2led))
            sum = sum + value(btnLeft2LED)*value(left2led);
        end
        if ~isnan(value(center2led))
            sum = sum + value(btnCenter2LED)*value(center2led);
        end
        if ~isnan(value(right2led))
            sum = sum + value(btnRight2LED)*value(right2led);
        end
    ...
    case 'monitor_inputs'
        ...
        if n_EVENTS_LIST > size(value(EVENTS_LIST), 1)
            ...
            for ii=1:size(strevs,1)
                %fprintf([strevs{ii, 2} '\n']);
                if strcmp(strtrim(strevs{ii, 2}), 'Cin')
                    set(HANDLES.uipanelCenterPoke, 'BackgroundColor', 'red');
                elseif strcmp(strtrim(strevs{ii, 2}), 'Lin')
                    set(HANDLES.uipanelLeftPoke, 'BackgroundColor', 'red');
                elseif strcmp(strtrim(strevs{ii, 2}), 'Rin')
                    set(HANDLES.uipanelRightPoke, 'BackgroundColor', 'red');
                elseif strcmp(strtrim(strevs{ii, 2}), 'cin')
                    set(HANDLES.uipanelCenterPoke2, 'BackgroundColor', 'red');
                elseif strcmp(strtrim(strevs{ii, 2}), 'lin')
                    set(HANDLES.uipanelLeftPoke2, 'BackgroundColor', 'red');
                elseif strcmp(strtrim(strevs{ii, 2}), 'rin')
                    set(HANDLES.uipanelRightPoke2, 'BackgroundColor', 'red');
                    
                elseif strcmp(strtrim(strevs{ii, 2}), 'Cout')
                    set(HANDLES.uipanelCenterPoke, 'BackgroundColor', 'green');
                elseif strcmp(strtrim(strevs{ii, 2}), 'Lout')
                    set(HANDLES.uipanelLeftPoke, 'BackgroundColor', 'green');
                elseif strcmp(strtrim(strevs{ii, 2}), 'Rout')
                    set(HANDLES.uipanelRightPoke, 'BackgroundColor', 'green');
                elseif strcmp(strtrim(strevs{ii, 2}), 'cout')
                    set(HANDLES.uipanelCenterPoke2, 'BackgroundColor', 'green');
                elseif strcmp(strtrim(strevs{ii, 2}), 'lout')
                    set(HANDLES.uipanelLeftPoke2, 'BackgroundColor', 'green');
                elseif strcmp(strtrim(strevs{ii, 2}), 'rout')
                    set(HANDLES.uipanelRightPoke2, 'BackgroundColor', 'green');
                end
            end
