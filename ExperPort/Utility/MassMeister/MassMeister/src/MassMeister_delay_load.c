 ...
 */
FARPROC WINAPI MassMeisterDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = MassMeisterDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = MassMeisterDelayLoadWin32FailureHook;
#endif
