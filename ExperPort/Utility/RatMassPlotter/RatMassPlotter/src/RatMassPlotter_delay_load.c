 ...
 */
FARPROC WINAPI RatMassPlotterDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = RatMassPlotterDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = RatMassPlotterDelayLoadWin32FailureHook;
#endif
