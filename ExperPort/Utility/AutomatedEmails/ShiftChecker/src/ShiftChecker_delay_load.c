 ...
 */
FARPROC WINAPI ShiftCheckerDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = ShiftCheckerDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = ShiftCheckerDelayLoadWin32FailureHook;
#endif
