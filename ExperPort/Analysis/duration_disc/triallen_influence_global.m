...
set(double(gcf),'Position', [3   200   389   237]);
...
set(double(gca),'XTickLabel', {'SHORT','LONG'}, 'XTick', [3 4],'XLim',[2 5],'YLim',[-1 1]); 
...
lbls = {};
figure;
set(double(gcf),'Position',  [401   200   832   244]);
subplot(1,2,1);
for c = [5 7]
...
set(double(gca),'XLim', [4 8], 'XTick', [5 7], 'XTickLabel',{'SHORT','LONG'});
...
set(double(gca),'XLim', [5 9], 'XTick', [6 8], 'XTickLabel',{'SHORT','LONG'});
