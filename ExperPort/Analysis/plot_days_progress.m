...
set(double(gca),'YTick', 0:5);
set(double(gca), 'YLim', [0 5]);
set(double(gca),'YTickLabel', {'0'; 'Primary'; 'Tone OFF, GO ON'; 'Secondary'; 'Final Task'; '1'});
%set(double(gca),'Units', 'pixels');
%p = get(double(gca),'Position');
%set(double(gca),'Position', [p(1) p(2) 150 p(4)]);