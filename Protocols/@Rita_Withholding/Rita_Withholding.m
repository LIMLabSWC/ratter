...
switch action,
    ...
    case 'init'
        ...
        my_state_colors = struct( ...
            ...
            'sp_time_out1_out_1',    [0.2 0.2 0.2], ...
            'sp_time_out1_out_2',    [0.2 0.2 0.2], ...
            'sp_time_out1_in',       [0.2 0.2 0.2], ...
            'sp_time_out1_ref',      [0.2 0.2 0.2], ...
        ...
        [x, y, ITIPokeTimeOut, AfterShortPoke] ...
...
%         [x, y]= PokeDuration(obj, 'init', x, y);
        ...
        SoloFunctionAddVaRS('StateMatrixSection', ...
            ...
            'ro_args', {CenterSmall, CenterLarge, ...
                        ...
                        ITIPokeTimeOut, AfterShortPoke, ...
                        BlockName, ...
                        VpdSmall_Current, VpdLarge_Current, ...
                        WaitPokeNecessary, TimeToFakePoke, ...
                        TrialLengthConstant, TrialLength, ...
                        IdToneSmall, IdToneLarge, IdToneSmallLarge, ...
