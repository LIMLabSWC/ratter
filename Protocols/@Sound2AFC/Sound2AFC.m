...
function create_gui(obj)
        ...
        DeclareGlobals(obj, 'rw_args', {'skip_to_reward', 'use_light_guides', ...
            'punish_errors', 'punish_fixation_breaks', 'cpoke_viol_state_dur','prot_title'});
...
function [sma, prep_next_trial_states] = build_sma(obj, trial_params)
    ...
    if skip_to_reward 
        offer_state_name = sprintf('offer_%s', correct_state);
        sma = add_state(sma, 'name', offer_state_name, ...
