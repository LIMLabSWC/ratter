...
switch action
    case 'init'
        ...
        % Keys must be valid MATLAB field names (no spaces/hyphens, no leading
        % digit); the wav files live in this folder so audioread finds them by
        % bare filename. The first four (bus/storm/leafblower/crowd) remain the
        % A/B/C/D defaults below; the rest are candidate stimuli selectable from
        % the GUI menus.
        SoloParamHandle(obj, 'sound_name_to_file_map', 'value', struct(...
            ...
            'pouring_coins',        '01_Pouring_coins2.wav', ...
            'jingling_keys',        '02_Jingling_keys.wav', ...
            'knife_sharpening',     '03_Knife_sharpening.wav', ...
            'castanets',            '04_Castanets2.wav', ...
            'shaking_coins',        '06_Shaking_coins.wav', ...
            'fire',                 '07_Fire__in_chimney.wav', ...
            'brushing_teeth', 'Brushing teeth.wav', ...
            'jogging', 'Jogging on gravel.wav', ...
            'linotype', 'Linotype.wav', ...
            'teletype', 'Teletype.wav', ...
            'river', 'Small river.wav', ...
            'water_lapping', 'Water lapping gently.wav', ...
            'lawn_mover', 'Lawn mower.wav', ...
            'insects', 'Insects during day in South.wav',...
            'blender', 'Blender.wav',...
            'adding_machine', 'Electric adding machine.wav' ...
        ...
        for i = length(labels):-1:1
            ...
            MenuParam(obj, sprintf('sound_%s_name', label), ...
                ...
                'label', 'Name');
            set_callback(eval(sprintf('sound_%s_name', label)), ...
                {'Sound2AFC', 'reload_sounds'});
            next_row(y);
