...
switch action
    case 'init'
        ...
        SoloParamHandle(obj, 'sound_name_to_file_map', 'value', struct(...
            ...
            'sander',               '05_Sander.wav', ...
            'shaking_coins',        '06_Shaking_coins.wav', ...
            'fire',                 '07_Fire__in_chimney.wav', ...
            'frying_bacon',         '08_Frying_bacon.wav', ...
            'power_saw',            '09_Power_saw2.wav', ...
            'synth_lo_slow_narrow', 'S1_loF_slow_narrow.wav', ...
            'synth_hi_fast_narrow', 'S2_hiF_fast_narrow.wav', ...
            'synth_hi_slow_broad',  'S3_hiF_slow_broad.wav', ...
            'synth_lo_fast_broad',  'S4_loF_fast_broad.wav' ...
