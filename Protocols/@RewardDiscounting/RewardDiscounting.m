...
function [obj] = RewardDiscounting(varargin)
...
%% INIT 
  case 'init'
    ...
    DeclareGlobals(obj, 'ro_args', {'hit_history', 'sides_history', 'choice_history'});
    SoloFunctionAddVars('RewardsSection', 'rw_args', {'hit_history', 'choice_history'});
