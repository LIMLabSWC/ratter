...
switch action,
 ...
 case 'next_matrix',
   ...
   b = rows(stm);
   %   od = fv_dur; %odor valve open duration, specified in OdorSection.
...
fd = value(final_valve_delay);     % set and modified in OdorSection
fdur = value(fv_dur); 
fv1 = center1water; 
...
auxai = value(log_aux); % trigger auxai high for measurement of vavle latency
   ...
   stm = [stm ; 
          ...
          b+1 b+1  b+1 b+1   b+1 b+1   b+2  fd    0    ov1  ov2    0 ; ... %  
          b+2 b+2  b+2 b+2   b+2 b+2   b+3  fdur fv1   ov1  ov2    0  ; ... % 
