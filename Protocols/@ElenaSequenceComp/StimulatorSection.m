...
% ----------------------------------------------------------------
  ...
  case 'init', 
      ...
      MenuParam(obj,'StimInterval',{'WholeTrial','S1','Delay1Dur','S2','Delay2Dur','S3'},1,x,y,'labelfraction',0.30); next_row(y);
  ...
  %% Case StimInterval  
    case 'StimInterval'
        ...
        elseif strcmp(StimInterval, 'S2');
            PulseWidth.value = A2_time*1000;
            StimFreq.value = 1000/PulseWidth;
            StartDelay.value = PreStim_time + A1_time + Del1_time;
        elseif strcmp(StimInterval, 'S3');
            PulseWidth.value = (A3_time+time_bet_aud2_gocue+time_go_cue)*1000+2000;
            StimFreq.value = 1000/PulseWidth;
            StartDelay.value = PreStim_time + A1_time + Del1_time + A2_time + Del2_time;
