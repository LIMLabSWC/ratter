...
switch action,
  ...
  case 'init'
    ...
    [x,y]=SoundInterface(obj,'add','ViolationSound',x,y,'Volume',0.01,'Freq',9000,'Duration',0.5); 
    ...
    next_column(x);
    y=10;
    [x,y]=SoundInterface(obj,'add','GoSound',x,y,'Style','Tone','Volume',0.01,'Freq',3000,'Duration',0.2);
    ...
    [x,y]=SoundInterface(obj,'add','SOneSound',x,y,'Style','WhiteNoise','Volume',0.08);
    [x,y]=SoundInterface(obj,'add','STwoSound',x,y,'Style','WhiteNoise','Volume',0.08);
    [x,y]=SoundInterface(obj,'add','SThreeSound',x,y,'Style','WhiteNoise','Volume',0.08);    
