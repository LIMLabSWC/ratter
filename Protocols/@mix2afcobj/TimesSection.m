...
switch action
 case 'init',
   ...
   NumeditParam(obj,'RewardAvail', 4, x, y);
   next_row(y); 
   
   NumeditParam(obj,'TrialLength', 15, x, y, 'TooltipString', ...
   ...
   NumeditParam(obj,'StdITI', 0, x, y, 'position', [x y 100 20], 'TooltipString', ...
                ['Standard dev. of the inter-trial interval ' ...
                 'distribution']); 
   NumeditParam(obj, 'MeanITI', 4, x, y,'position', [x+100 y 100 20],  ...
   ...
   NumeditParam(obj, 'od_min', 0.2, x, y, 'position', [x y 100 20], ...
       'TooltipString', ['min. of uniform distrib of odor delay']);
   
   NumeditParam(obj, 'od_max', 0.5, x, y, 'position', [x+100 y 100 20], ...
       'TooltipString', ['max. of uniform distrib of odor delay']);
   next_row(y);

   NumeditParam(obj, 'valid_samp_time', 0.01, x, y, 'TooltipString',...
   ...
   NumeditParam(obj, 'rd_max', 0.5, x, y, 'position', [x+100 y 100 20], ...
   ...
   NumeditParam(obj, 'Penalty_ITI', 6, x, y);next_row(y);
   
   SubheaderParam(obj, 'tm_sbh', 'ITI & Reward Avail.', x, y);

   SoloFunctionAddVars('make_and_upload_state_matrix', 'ro_args', {'TrialLength', 'Penalty_ITI', 'valid_samp_time', 'od_min', 'od_max',...
       'max_odor_time', 'odor_delay_list', 'reward_delay_list'});
