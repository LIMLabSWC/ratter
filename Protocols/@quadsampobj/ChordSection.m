function  [x,  y,  chord_sound_len, go_dur, Sound_type, ...
           Granularity, LegalSkipOut] = ChordSection(obj, action, x, y)
%
...
switch action,
    case 'init'
        ...
        set_callback({SoundSPL_L, SoundSPL_R, SoundDur, BaseFreq, NTones, ...
            ...
            CenterProb, CluckLoc, CluckVol}, {'ChordSection', 'make'});

        set_callback({Left1_F1, Left1_F2, Left2_F1, Left2_F2, ...
