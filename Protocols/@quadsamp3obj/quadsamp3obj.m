...
SoloParamHandle(obj, 'reaction_times',   'value', NaN*ones(1, value(maxtrials)));
SoloParamHandle(obj, 'prevtrial',        'value', []);


DeclareGlobals(obj, 'ro_args', {'n_done_trials', 'n_started_trials', ...
                    'hit_history', 'reaction_times', 'prevtrial'});
...
[x, y] = ReactionTimeWaterSection(obj,  'init', x, y);  next_row(y, 0.5);
...
[x, y, chord_sound_len,go_dur,Sound_type,LegalSkipOut]=...
    ChordSection(obj, 'init', x, y); next_row(y, 0.5);

[x, y] = TimesSection(obj, 'init', x, y); next_row(y, 1);
...
SoloParamHandle(obj, 'ProcessedEventCouner', 'value', 0);

SoloFunction('RewardsSection', ...
             'rw_args', ...
             {'LastTrialEvents', 'ProcessedEventCouner', ...
              'hit_history', 'reaction_times'}, ...
             'ro_args', {'RealTimeStates', 'side_list'});
[x, y] = RewardsSection(obj, 'init', x, y);
SoloFunction('PokeMeasuresSection', ...
             'rw_args', {'LastTrialEvents', 'ProcessedEventCouner'}, ...
...
SoloParamHandle(obj, 'debugging', 'value', 1);
if debugging==1, 
