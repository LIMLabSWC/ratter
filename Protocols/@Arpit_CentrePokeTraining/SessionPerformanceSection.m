...
switch action
	...
	case 'init'
		...
		DispParam(obj, 'ntrials', 0, x, y,'label','Session Trial Counter', 'TooltipString', ...
			'trials done in this session'); 
        next_row(y);
        DispParam(obj, 'ntrials_stage', 0, x, y,'label','Session Trial Counter', 'TooltipString', ...
			'trials completed in this training stage'); 
        next_row(y);
		DispParam(obj, 'violation_rate', 0, x, y,'label','Session Violation Rate', 'TooltipString', ...
			'Fraction of trials with a center poke violation in this session'); 
        next_row(y);
        DispParam(obj, 'timeout_rate', 0, x, y,'label','Session Timeout Rate', 'TooltipString', ...
			'Fraction of trials with timeout in this session'); 
        next_row(y);
		DispParam(obj, 'violation_recent', 0, x, y,'label','Recent Violation Rate', 'TooltipString', ...
			'Fraction of trials with a center poke violation in the past 20 trials'); 
        next_row(y);
		DispParam(obj, 'timeout_recent', 0, x, y,'label','Recent Timeout Rate', 'TooltipString', ...
			'Fraction of trials with a center poke violation in the past 20 trials'); 
        next_row(y);
		DispParam(obj, 'violation_stage', 0, x, y,'label','Stage Violation Rate', 'TooltipString', ...
			'Fraction of violations in this training stage'); 
        next_row(y);
		DispParam(obj, 'violation_stage', 0, x, y,'label','Stage Timeout Rate', 'TooltipString', ...
