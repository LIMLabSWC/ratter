...
if isempty(olf_IP)
    ...
    save('C:\Home\RatExper\ExperPort\Protocols\@nl_odorsamp2obj\olfip', 'olf_IP');
else
...
SoloParamHandle(obj,'valve_delay_logging', 'value', '');
if ~strcmpi(value(OLF_IP), 'nan'), % if the olfactometer is connectable
    ...
    valve_delay_logging.value = 'OdorSection(obj, ''get_valve_delay'');';
end
