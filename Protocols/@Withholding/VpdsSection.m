...
%         SoloParamHandle(obj, 'myfig', 'value', figure, 'saveable',0);
        ...
        DispParam(obj, 'VpdCue_N', 0.0001, x, y);  next_row(y);
        DispParam(obj, 'VpdRest_N', 0.0001, x, y);  next_row(y);
    ...
    case 'prepare_next_trial',
        ...
        VpdCue_N.value=0.5*value(VpdLarge_Current_N);%for vpd2
        VpdRest_N.value=value(VpdLarge_Current_N)-VpdCue_N;%vpd3
