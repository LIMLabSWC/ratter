...
switch action,
 case 'init',
   ...
   EditParam(obj, 'LargeReward_ul', 40, x, y); next_row(y);
   EditParam(obj, 'SmallReward_ul', 10, x, y); next_row(y);
      DispParam(obj, 'CenterSmall', NaN, x, y, 'position', [x y 100 20]);
   DispParam(obj, 'CenterLarge', NaN, x, y, 'position', [x+100 y 100 20]); next_row(y);
