...
switch action,
	...
	case 'init'
        ...
        NumeditParam(obj, 'A2_time', 0.4, x,y,'label','AUD2 On Time','TooltipString','Duration of second stimulus');
        next_row(y);
        set_callback(A2_time, {mfilename, 'new_CP_duration'});
        NumeditParam(obj, 'A3_time', 0.4, x,y,'label','AUD1 on Time','TooltipString','Duration of third stimulus');
        next_row(y);
        set_callback(A3_time, {mfilename, 'new_CP_duration'});
        NumeditParam(obj, 'Del1_time', 0.2, x,y,'label','First Delay Duration Time','TooltipString','Duration of first delay period');
        next_row(y);
        set_callback(Del1_time, {mfilename, 'new_CP_duration'});
        NumeditParam(obj, 'Del2_time', 0.2, x,y,'label','Second Delay Duration Time','TooltipString','Duration of second delay period');
        next_row(y);
