...
function  [varargout] =  SequenceCompSMA(obj, action)
...
switch action
	...
	case 'prepare_next_trial',
        ...
        sthree_sound_id     = SoundManagerSection(obj, 'get_sound_id', 'SThreeSound');
        ...
        A3_sound_id  = SoundManagerSection(obj, 'get_sound_id', 'StimAUD3');
...
% 			'sustain', go_cue_duration, 'sound_trig', go_sound_id);
        ...
        sma = add_scheduled_wave(sma, 'name', 'stimA2', 'preamble', PreStim_time+A1_time+Del1_time, ...
		        'sustain', A2_time,'sound_trig', A2_sound_id);
            
        sma = add_scheduled_wave(sma, 'name', 'stimA3', 'preamble', PreStim_time+A1_time+Del1_time+A2_time+Del2_time, ...
		        'sustain', A3_time,'sound_trig', A3_sound_id);
...
%                 sma = add_state(sma,'name','trigscope','self_timer',0.00001, ...
...
% 					'input_to_statechange', {'Tup','wait_for_cpoke'});  
				...
				sma = add_state(sma,'name','cp','self_timer', SettlingIn_time+0.00001, ...
					'output_actions', {'SchedWaveTrig', 'center_poke + settling_period +stimA1+stimA2+stimA3'}, ...
					'input_to_statechange', {'Tup', 'cp_legal_cbreak_period', ...
					    'Cout','current_state+1', ...
					    'center_poke_Out', 'wait_for_collecting_reward', ...
						'Rin',  'violation_state', ...
...
% 			'input_to_statechange',{'Tup','check_next_trial_ready'});
		...
		sma = add_state(sma,'name','violation_state','self_timer',viol_snd_duration,...
			'output_actions',{'SchedWaveTrig', '-center_poke-stimA1-stimA2-stimA3', ...
			    'SoundOut',viol_sound_id, 'DOut', center1led},...
			'input_to_statechange', {'Tup', 'current_state+1'});
        end
