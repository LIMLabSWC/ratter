...
switch action,
    ...
    case 'get350',
        ...
        LastTrialEvents.value=events;
         ...
         %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    cinID=1; coutID=2; linID=4; loutID=8; rinID=16; routID=32; 
    ainID1=64; ainID2=128; ainID3=256; ainID4=512; toutID=1024;
    ...
    %%%%%%%%%%Trial Data extraction%%%%%%%%%%
       ...
       if ~isempty(idx_cin),
         if events(idx_cin(1),4)==55, %55:Fpks (fake poke state)
       ...
       if events(idx_fact,2)==linID|events(idx_fact,2)==rinID,
       ...
       elseif ismember(events(idx_rew(1),4), rts.small_reward),
           g_reward(n_done_trials)=2;
       elseif ismember(events(idx_rew(1),4), rts.large_reward),
