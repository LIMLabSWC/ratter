...
itistart    = 240;  % start of iti and timeout parts of program
...
ItiS = itistart+6;  % intertrial interval state
TouS = itistart+9;  % penalty timeout state
...
for i=1:3,  % Extra Iti states: lower trig and play sound...
    b = size(stm,1);
    stm = [stm ; ...
