function out = Tone2AFC_50_200ms_15k2k(varargin)
...
switch action
    ...
    case 'init'
        ...
        Dur  =[ 200   200   200    50     50    50    50   50   50   200   200  200 ];  %msec
        SPL  =[  69    59    49    69     59    49    40   52   64    40    52   64 ];  %Max=PPdB SPL
        TmOut=[   6     4     3     6      4     3     3    4    6     3     4    6 ];  %Sec
        Str  ={'15k 69dB 200ms','15k 59dB 200ms','15k 49dB 200ms','15k 54dB 69ms','15k 49dB 59ms','15k 49dB 50ms',...
                '2k 40dB 50ms','2k 52dB 50ms','2k 64dB 50ms','2k 40dB 200ms','2k 52dB 200ms','2k 64dB 200ms'};
%         Freq=fliplr(Freq);
%         Str=fliplr(Str);
%         TmOut=fliplr(TmOut);
