function [x, y] = OdorSection(obj, action, x, y)
   ...
   switch action
    case 'init',   % ---------- CASE INIT -------------
      ...
      next_row(y);
      NumeditParam(obj, 'odor_duration', 0.5, x, y); next_row(y);
      NumeditParam(obj, 'final_valve_delay', 0.1, x, y);
      next_row(y,1.5);
  ...
  % ***** Determine the bank ID **************************************
      ...
      SoloFunctionAddVars('make_and_upload_state_matrix', 'ro_args',...
          {'ValveID1','ValveID2','ActiveBank1ID','ActiveBank2ID','odor_duration', 'log_aux','final_valve_delay'});
