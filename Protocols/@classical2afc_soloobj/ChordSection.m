...
switch action
 ...
 case 'upload_sounds'   % ------------- CASE 'UPLOAD_SOUNDS' ------------
   if sounds_uploaded==0,
      LoadSound(rpbox('getsoundmachine'), 1, amp*sounds{1}', 'both', 3, 0);
      LoadSound(rpbox('getsoundmachine'), 2, amp*sounds{2}',  'both', 3, 0);
      LoadSound(rpbox('getsoundmachine'), 4, amp*sounds{3}', 'both', 3, 0);      
