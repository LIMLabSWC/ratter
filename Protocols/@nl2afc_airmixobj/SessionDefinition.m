...
switch action
    case 'init'   % ------- CASE 'INIT' ----------
        ...
        SoloParamHandle(obj, 'blk_cnt',   'value', 0);
        SoloParamHandle(obj, 'score_cnt',     'value', 0);
        ...
        set(value(sessionfig), 'Position', [3 100 700 400], 'Menubar', 'none', 'Toolbar', 'none');
        PushbuttonParam(obj, 'reinit', 200, 3, 'position', [300 10 70 20]);
    ...
    case 'mark_complete'
        ...
        if rows(ts)>0,
            ...
            elseif value(display_type) == 2
                set(get_lhandle(train_string_display), 'String', ['Showing: Stage #' num2str(val) ': Completion string']);
 ...
 case 'train_list',
   switch value(display_type),
    ...
    case 'show_train_string'
        ...
        show_train.value = 1; show_complete.value = 0; show_name.value = 0;
    ...
    case 'show_complete_string'
        ...
        show_train.value = 0; show_complete.value = 1; show_name.value = 0;
    ...
    case 'change_active_stage'
      ...
      if strcmpi(ans, 'yes')
         sm = value(my_session_model);
         my_session_model.value = debugged_jump(sm, 'to', v);
         training_stages.value =get_training_stages(value(my_session_model));
         active_stage.value = ...
