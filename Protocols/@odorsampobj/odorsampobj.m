...
if nargin==1 && isstr(name),
    SoloParamHandle(obj, 'protocol_name', 'value', lower(name));
end;
...
% Section that sets reward parameters 
...
HeaderParam(obj, 'prot_title', 'CenterSamp/OdorSamp', ...
