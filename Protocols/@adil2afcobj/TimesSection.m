...
switch action
 case 'init',
   ...
   NumeditParam(obj,'TrialLength', 15000, x, y, 'TooltipString', ...
   ...
   NumeditParam(obj, 'valid_samp_time', 0.02, x, y, 'TooltipString',...
   ...
   NumeditParam(obj, 'rd_min', 0.02, x, y, 'position', [x y 100 20], ...
       'TooltipString', ['min. of uniform distrib of reward delay (between water poke in and water valve on)']);
   
   NumeditParam(obj, 'rd_max', 0.05, x, y, 'position', [x+100 y 100 20], ...
