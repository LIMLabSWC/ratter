function [x, y, iti_list, RewardAvail,PreChordTime] = TimesSection(obj, action, x, y)
...
switch action
 case 'init',
   ...
   NumeditParam(obj,'PreChordTime', 0.01, x, y, 'TooltipString', ...
                ['Mandatory time (in sec.) in Cpoke, before GO sound']); next_row(y); 
   ...
   next_row(y,0.5);
   SubheaderParam(obj, 'tm_sbh', 'Times', x, y);next_row(y);
