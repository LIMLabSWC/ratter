...
olf_IP = inputdlg('The IP address of the olfactometer:');
%if isempty(olf_IP)
 %   errordlg('You need IP of the olfactometer. Please load the protocol again');
  %  return;
%end
...
set(value(myfig), 'Position', [485   244   630   550]);
